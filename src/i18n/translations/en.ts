...
export const en: Translations = {
  ...
  'meta.memory.name': 'Cosmic entanglement',
  'meta.memory.desc': 'Global Complexity ×1.5 (permanent).',
  'meta.echo.name': 'Creative impulse',
  'meta.echo.desc': 'Click power ×2 (permanent).',
  'meta.rebirth.name': 'Pebble resonance',
  'meta.rebirth.desc': 'Pebble power ×2 (permanent).',
