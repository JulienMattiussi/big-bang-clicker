...
export const fr = {
  ...
  'endgame.keeps.list': 'Échos, améliorations méta et galets de l’infini',
  ...
  'meta.memory.name': 'Intrication cosmique',
  'meta.memory.desc': 'Complexité globale ×1.5 (permanent).',
  'meta.echo.name': 'Élan créateur',
  'meta.echo.desc': 'Puissance des clics ×2 (permanent).',
  'meta.rebirth.name': 'Résonance des galets',
  'meta.rebirth.desc': 'Puissance des galets ×2 (permanent).',
