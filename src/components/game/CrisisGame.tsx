...
import { GasLeakGame } from './GasLeakGame'
import { SurviveGame } from './SurviveGame'

/** Routes the active crisis fight to its mini-game. Extinction, the revolt, the
 *  spice cartel and the era-19 gas leak keep their bespoke games; every other
 *  confronted crisis (the era-14 ones) shares the simple SurviveGame. */
export function CrisisGame() {
  ...
  if (fighting === 'gasLeak') return <GasLeakGame />
  return <SurviveGame />
}
