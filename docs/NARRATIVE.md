...
|---|---|---|---|
| Star Wars | Invention d'un **couteau à huître laser** (lame d'énergie pour ouvrir les huîtres), vite **abandonné car peu fiable** (instable, dangereux pour l'utilisateur) | 15 (Technologies) | Invention absurde / abandonnée |
| Asimov, Fondation | **Intégré (e18, transition)** : **Harry Sheldon** prétend avoir inventé une science prédictive infaillible et annonce la fin de l'univers pour très bientôt (par une obscure histoire de plaque de cuisson, cf. ère 19) ; personne ne le prend au sérieux | 18 (La grande unification) | Évènement narratif / clin d'oeil |
...
| H2G2 | **Drive à improbabilité infinie** : propulsion absurde alternative à l'effet de masse | 16-18 (Spatial) | Techno absurde / clin d'oeil |
...
- **Religions** (ère 13) : un sous-système discret ou une chaine d'évènements
...
- **Terre-ordinateur + 42 (H2G2)** : la Terre (ères 5-6) peut être présentée
...
- **Galets peints de l'infini** : chacun peut correspondre à un domaine
  ...
  - Esprit -> intelligence / recherche (ères 12, 15)
  - Âme -> vie / biomasse (ères 7-11)
  ...
  - **Galet de la diversité (implémenté, ère 10)** : au-delà des six pierres, un
...
- **Octarine (Disque-monde)** : la réserver, en touche **discrète**, aux
  ...
  chats".
- **Cultivateurs / effet de masse** (ères 17-18) : intégrer aux widgets
...
| Tsiolkovski (ère 16) | « La Terre est un berceau, pas une demeure » | "Earth is the cradle of humanity, but one cannot live in the cradle forever" |
